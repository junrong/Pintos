...
/* Creates a new kernel thopened_fileread named NAME with the given initial
...
thread_current (void) 
{
  ...
  /* Make sure T is really a thread.
     ...
     recursion can clist_push_back(&thread_current()->opened_filesause stack overflow. */
  ASSERT (is_thread (t));
...
/* check if the thread with tid exits or not */
bool
is_thread_exit (tid_t tid) {
